...
from cybernexvpn_bot import new_text_storage, config
from cybernexvpn_bot.bot import states
from cybernexvpn_bot.bot.client_utils.clients import (
    get_user_clients,
    create_client,
    get_config_file,
    get_client,
...
from cybernexvpn_bot.bot.client_utils.payments import (
    get_transactions_history,
    gen_payment_url,
)
from cybernexvpn_bot.bot.client_utils.promo_codes import apply_promo_code
from cybernexvpn_bot.bot.client_utils.servers import get_server, get_servers
from cybernexvpn_bot.bot.client_utils.users import (
    get_or_create_user,
    check_and_apply_invitation,
    get_user,
)
from cybernexvpn_bot.bot.utils import (
...
async def handle_specific_device_query(
    ...
    data = await _get_client_data(client)
