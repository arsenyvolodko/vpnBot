...
from cybernexvpn_bot.config import START_BALANCE
...
MAIN_MENU_TEXT = (
    "Меню\n"
    'Для управления устройствами, перейди в раздел "Устройства".\n'
    'Для пополнения баланса, перейди в раздел "Финансы".'
)
...
CLIENT_NOT_FOUND_ERROR_MSG = "Упс! Похоже, такое устройство больше не доступно."
...
PROMO_CODE_SUCCESSFULLY_APPLIED = "Промокод успешно применен!\nВаш баланс пополнен на {}₽"
...
DEVICE_SUCCESSFULLY_REACTIVATED = "Подписка на устройство успешно возобновлена! С твоего счета списано {}₽."
