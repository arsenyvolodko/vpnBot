...
def to_main_menu_keyboard():
    keyboard = types.InlineKeyboardMarkup()
    keyboard.add(types.InlineKeyboardButton(text='Android', url=WG_APP_ANDROID_LINK))
    keyboard.add(types.InlineKeyboardButton(text='iOS', url=WG_APP_IOS_LINK))
    keyboard.add(types.InlineKeyboardButton(text='PC', url=WG_APP_PC_LINK))
