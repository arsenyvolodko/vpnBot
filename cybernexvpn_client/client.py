...
from cybernexvpn_client.configuration import Configuration
from cybernexvpn_client.enums import MethodEnum

import logging

from cybernexvpn_client.errors import (
    NotFoundError,
    InvalidRequestDataError,
    ClientBaseError,
)
from cybernexvpn_client.schemas import CreatePaymentRequest
...
async def func():
    async with CyberNexVPNClient() as api_client:
        pass
        # res = await api_client.get_transaction_history(506954303)
        # return res
