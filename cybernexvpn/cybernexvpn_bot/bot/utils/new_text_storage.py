...
WINDOWS_CONNECTION_INSTRUCTION = (
    '1️⃣ Скачай <a href="https://www.wireguard.com/install/">приложение</a> Wireguard\n'
    "2️⃣ Скачай файл в сообщении выше\n"
    '3️⃣ Открой Wireguard, нажми "Добавить туннель" и выбери скачанный файл\n'
)

MACOS_CONNECTION_INSTRUCTION = (
    '1️⃣ Скачай <a href="https://apps.apple.com/ru/app/wireguard/id1451685025?mt=12">приложение</a> Wireguard\n'
    "2️⃣ Скачай файл в сообщении выше\n"
    '3️⃣ Открой Wireguard, нажми "Импорт туннеля из файла" и выбери скачанный файл\n'
)

ANDROID_CONNECTION_INSTRUCTION = (
    '1️⃣ Скачай <a href="https://play.google.com/store/apps/details?id=com.wireguard.android">приложение</a> Wireguard\n'
    "2️⃣ Открой файл в сообщении выше и поделись им в приложение Wireguard\n\n"
    "Ура! Теперь можно смотреть рилсы!"
)

IPHONE_CONNECTION_INSTRUCTION = (
    '1️⃣ Скачай <a href="https://apps.apple.com/us/app/wireguard/id1441195209">приложение</a> Wireguard\n'
    "2️⃣ Сделай 5 тыков, как показано на фото выше (поверь, оно того стоит..)\n\n"
    "Ура! Теперь можно смотреть рилсы!"
)
...
WHAT_IS_WRONG_QUESTION = (
    "В чем проблема?\n"
    "1️⃣ Не выходит добавить файл, как описано в инструкции\n"
    "2️⃣ Получилось добавить файл в приложение, но vpn не работает\n"
    "3️⃣ Другое\n"
)
...
ANDROID_ALTERNATIVES = (
    "Если у тебя есть рядом другое устройство, на котором можно открыть QR-код, нажми на кнопку ниже.\n\n"
    'Также ты можешь скачать файл с данными для подключения, затем в приложении Wireguard выбрать "Импорт туннеля из файла" и выбрать скачанный файл\n\n'
    f'Если это не помогло или возникли проблемы при добавлении - просто напиши <a href="{config.ADMIN_TG_URL}">мне</a>, я обязательно помогу!'
)

QR_CODE_INSTRUCTION = (
    "1️⃣ Открой qr код на другом устройстве\n"
    '2️⃣ Открой приложение wireguard на телефоне\n'
    '3️⃣ Нажми на "+" или "Добавить туннель", а затем выбери "Импорт туннеля из qr-кода"\n'
    '4️⃣ Отсканируй qr код и введи любое название для туннеля, например "vpn"\n\n'
    'Ура! Теперь можно смотреть рилсы!'
)
